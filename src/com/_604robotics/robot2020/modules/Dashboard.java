...
public class Dashboard extends DashboardModule {
  ...
  public final Output<AutonMode> autonMode =
      addDashboardOutput("autonMode", AutonMode.MANUAL, AutonMode.class);

  public final Output<DriveMode> driveMode =
      addDashboardOutput("driveMode", DriveMode.DYNAMIC, DriveMode.class);

  public final Output<MarionetteRecorder> marionetteRecorder =
      addDashboardOutput("marionetteRecorder", MarionetteRecorder.MANUAL, MarionetteRecorder.class);

  public final Output<MarionetteOutput> marionetteOutput =
      addDashboardOutput("marionetteOutput", MarionetteOutput.MANUAL, MarionetteOutput.class);

  public final Output<Boolean> recordAuton = addDashboardOutput("recordAuton", false);
  public final Output<String> marionetteFile =
      addDashboardOutput("marionetteFile", "autonomous.marionette");
  ...
  public final Input<String> manualPrimaryReadFile =
      addDashboardInput("Manual Primary Read File: ", "");
  public final Input<String> manualSecondaryReadFile =
      addDashboardInput("Manual Secondary Read File: ", "");
